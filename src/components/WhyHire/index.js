import Hire from "assets/images/why-hire.svg";
import "./WhyHire.css";
    ...
    return (
        <div className="bg-secondary custom-radius py-14">
            <div className="grid grid-cols-2 items-center container">
                <div>
                    <img src={Hire} alt="Hire me" className="w-[450px] ml-auto" />
                </div>
                <div className="w-2/3 mr-auto">
                    ...
                    <p className="poppins text-2xl font-normal text-gray-800 mb-2">15+</p>
                    <p className="text-gray-500 text-xs mb-14">Project Completed</p>
                    <a href=" " className="border border-gray-800 p-5 px-10 rounded-2xl font-semibold text-xl">Hire me</a>
                </div>
            </div>
        </div>
    );
